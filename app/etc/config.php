...
return [
    'modules' => [
        ...
        'Magesales_Shippingtable' => 0,
        'Owebia_AdvancedSettingCore' => 0,
        'Owebia_AdvancedShipping' => 0,
        'Rcreek_AlsoAvailable' => 1,
        'Rcreek_AlsoImporter' => 0,
        'Rcreek_BlockOverrides' => 1,
        'Rcreek_CategoryPageSubcategoryImages' => 1,
        'Rcreek_CollectInStore' => 0,
        'Rcreek_CrossCategoryLink' => 1,
        'Rcreek_DimensionsPlusImporter' => 0,
        'Rcreek_HomeOnNav' => 1,
