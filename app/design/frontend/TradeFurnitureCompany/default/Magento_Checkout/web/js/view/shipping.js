...
define([
    ...
    return Component.extend({
        ...
        selectShippingMethod: function (shippingMethod) {
            ...
            if(shippingMethod.method_code === 'amstrates2' && shippingMethod.carrier_code === 'amstrates'
                || shippingMethod.method_title === 'Click and Collect'){

                let input = document.getElementById('cashondelivery1');
                let parent = input.closest("div.payment-method");
                ...
                for (let item of paymentMethods) {
                    if(!item.classList.contains('_active')){
                        ...
                        $("div.payment-method input:checked").prop('checked',false);
                        item.style.display = 'none';
                    }
                }
                ...
                let paymentMethods = document.getElementsByClassName("payment-method ");
                let input = document.getElementById('cashondelivery1');
                let wrapper = input.closest("div.payment-method");
                for (let item of paymentMethods) {
                    if(!item.classList.contains('_active')){
