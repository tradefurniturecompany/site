...
namespace Amasty\MegaMenu\Plugin\View\Page\Config;
...
class Renderer
{
    const CACHE_KEY = 'ammegamenu_should_load_css_file';
    ...
    public function beforeRenderAssets(
        ...
        if ($shouldLoad) {
            $this->config->addPageAsset('Amasty_MegaMenu::css/source/mkcss/ammenu.css');
        }
