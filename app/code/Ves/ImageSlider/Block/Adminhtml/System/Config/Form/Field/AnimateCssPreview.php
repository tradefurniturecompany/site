		...
		$script .= '<script>
			require(["jquery"],function(){
				jQuery(document).ready(function() {
					jQuery("body").append(\'<div class="animate-preview" style="position: fixed;z-index: 9999;top: -100%;width: 80%;height: 80%;left: 10%;right:10%"><div class="btn-preview-close" style="position: absolute;right: 0;padding: 5px;cursor: pointer;background: #eb5202;color: #FFF;"><span>Close</span></div><iframe style="width:100%;height:100%" src="https://daneden.github.io/animate.css"></iframe></div>\');
				});
