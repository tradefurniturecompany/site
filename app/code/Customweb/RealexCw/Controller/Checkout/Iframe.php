...
class Iframe extends \Customweb\RealexCw\Controller\Checkout
{
	public function execute()
	{
		$context = $this->_authorizationMethodFactory->getContextFactory()->createTransaction();
		/* @var $authorizationMethodAdapter \Customweb\RealexCw\Model\Authorization\Method\Iframe */
		...
		$resultPage->getLayout()
			->getBlock('customweb_realexcwcheckout_iframe')
