...
class Index extends \Customweb\RealexCw\Controller\Adminhtml\Config
{
	public function execute()
	{
		...
		$resultPage->setActiveMenu('Customweb_RealexCw::config');
		$resultPage->addBreadcrumb('Realex', 'Realex');
		$resultPage->getConfig()->getTitle()->prepend(__('Realex'));
		return $resultPage;
	}
}