 ...
 *
 */
final class Customweb_Realex_Method_SofortMethod extends Customweb_Realex_Method_AbstractAlternativeMethod {
	...
	public function getPaymentMethodDetailsElement($transaction){
		...
		$element = "<paymentmethod>" . $this->getPaymentMethodHashParam() . "</paymentmethod>" .
			"<paymentmethoddetails>" .
				"<ReturnURL>" . $this->container->getBean('Customweb_Payment_Endpoint_IAdapter')->getUrl("process", "common", $parameterArray) . "</ReturnURL>" .
			"</paymentmethoddetails>";
