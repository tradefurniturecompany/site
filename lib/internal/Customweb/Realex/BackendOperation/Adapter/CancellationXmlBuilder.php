 ...
 *
 */
class Customweb_Realex_BackendOperation_Adapter_CancellationXmlBuilder extends Customweb_Realex_BackendOperation_AbstractXmlBuilder  {
	
	public function buildXml() {
		return $this->getXmlHeader('void') .
